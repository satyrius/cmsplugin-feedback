...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeedbackPlugin.title'
        db.delete_column(u'cmsplugin_feedback_feedbackplugin', 'title')


    def backwards(self, orm):
        # Adding field 'FeedbackPlugin.title'
        db.add_column(u'cmsplugin_feedback_feedbackplugin', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Feedback', max_length=255),
                      keep_default=False)
